...
use crate::shader_settings::light::{Light, LightBuffer};
use crate::shader_settings::shadowmap::ShadowUniformBuffer;
...
impl UniformSetting {
    pub fn new(
        ...
        shadow_uniform_buffer: &ShadowUniformBuffer,
                ...
                entries: &[
                    wgpu::BindGroupLayoutEntry {
                        ...
                        ty: wgpu::BindingType::Buffer {
                            ...
                            has_dynamic_offset: false, // 動的配列を使うか否かみたいな意味
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        ...
                        resource: wgpu::BindingResource::Buffer {
                            buffer: &buffer,
                            offset: 0,
                            size: wgpu::BufferSize::new(Uniforms::size()),
                        }
                    },
                    wgpu::BindGroupEntry {
                        binding: 1,
                        resource: wgpu::BindingResource::Buffer {
                            ...
                            offset: 0,
                            size: wgpu::BufferSize::new(light_buffer.get_size()),
                        }
                    },
                    wgpu::BindGroupEntry {
                        binding: 2,
                        resource: wgpu::BindingResource::Buffer {
                            buffer: &shadow_uniform_buffer.buffer,
                            offset: 0,
                            size: wgpu::BufferSize::new(shadow_uniform_buffer.get_size()),
                        },
                    },
                    wgpu::BindGroupEntry {
                        binding: 3,
