...
impl ShadowUniformBuffer {
    pub fn new(device: &wgpu::Device, uniforms: &[ShadowUniform]) -> Self {
        ...
        let size = (uniforms.len() * std::mem::size_of::<ShadowUniform>() as usize)
...
impl ShadowMap {
    ...
    pub fn new(
        ...
        let uniform_buffer_for_bake_size = std::mem::size_of::<ShadowUniform>() as wgpu::BufferAddress;
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        ...
                        resource: wgpu::BindingResource::Buffer {
                            buffer: &uniform_buffer_for_bake,
                            offset: 0,
                            size: wgpu::BufferSize::new(uniform_buffer_for_bake_size),
                        },
                    },
                ],
                label: None,
